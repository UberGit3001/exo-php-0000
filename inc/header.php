...
<head>
  ...
  <link rel="stylesheet" href="/exo-php-0000/style.css">
  <!-- <link rel="stylesheet" href="/exo-php-0000/styles.css"> -->
    ...
    <header>
      <nav>
        <ul>
          ...
          <li>
          <a href="#"><i class="fa-solid fa-scale-balanced"></i> Exercice N°2</a>
          <ul>
          ...
          <li>
          <a href="#"><i class="fa-solid fa-xmark"></i> Exercice N°3</a>
          <ul>
          ...
          <li>
          <a href="#"><i class="fa-solid fa-xmark"></i> Exercice N°5</a>
            <ul>
          ...
          <li>
          <a href="#"><i class="fa-solid fa-xmark"></i> Exercice N°6</a>
            <ul>
